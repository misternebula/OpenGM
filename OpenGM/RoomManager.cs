...
public static class RoomManager
{
    ...
    private static void OnRoomChanged()
    {
        ...
        foreach (var obj in CurrentRoom.RoomAsset.GameObjects)
        {
            ...
            var newGM = new GamemakerObject(definition, obj.X, obj.Y, definition.depth, obj.InstanceID, definition.sprite, definition.visible, definition.persistent, definition.textureMaskId, definition.solid);
